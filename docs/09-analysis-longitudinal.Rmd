...
```{r}
m2 <- tslm(arson_rate ~ pop_delta + manu_delta, data = long)

summary(m2)
```

```{r}
m2 <- tslm(arson_rate ~ pop_delta + manu_delta5, data = long)

summary(m2)
```

```{r}
m3 <- tslm(arson_rate ~ violent_rate + larceny_rate + pop_delta + manu_delta, data = long)
